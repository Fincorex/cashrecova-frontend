            ...
            <div className="flex-1 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3 sm:gap-6">
                    ...
                    <div className="relative">
                        ...
                        >
                            <Icon icon="solar:bell-bing-outline" width="24" height="24" className="group-hover:shake" />
                                        ...
                                        <div key={i} className="p-5 hover:bg-slate-50/50 cursor-pointer transition-colors border-b border-slate-50 group">
                                            <div className="flex gap-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-xs text-slate-500 line-clamp-2 leading-relaxed">Your monthly report for April has been generated and is ready for review.</p>
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <div className="hidden sm:block text-left">
                                ...
                                <p className="text-[11px] font-medium text-slate-500">Platform Manager</p>
                            </div>
                        ...
                        {isUserOpen && (
                            <div className="absolute right-0 mt-3 w-64 bg-white border border-slate-200/80 rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 origin-top-right">
                                <div className="p-6 border-b border-slate-100 bg-slate-50/50">
                                    ...
                                    <p className="text-xs font-medium text-slate-500 mt-0.5 truncate">admin@cashrecova.com</p>
                                </div>
                                <div className="p-3">
                                    <button className="w-full flex items-center gap-3 px-4 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 hover:text-primary-500 rounded-2xl transition-all group">
